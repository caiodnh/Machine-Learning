...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        delActivation_delZ = np.vectorize(rectified_linear_unit_derivative)(hidden_layer_weighted_input)
        hidden_layer_error = np.vectorize(lambda x: output_layer_error * x)(np.multiply(np.transpose(self.hidden_to_output_weights), delActivation_delZ))
