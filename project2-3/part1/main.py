from features import center_data, principal_components
import sys
import numpy as np
...
# print(run_linear_regression_on_MNIST(lambda_factor=1))
# print(run_linear_regression_on_MNIST(lambda_factor=0.1))
...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    center_train, feature_means = center_data(train_x)
    n_components = 18
    pcs = principal_components(center_train)
